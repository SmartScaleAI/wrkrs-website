    ...
    <main>
      ...
      <section className="hero grid-shell" id="top">
        <div className="hero-copy">
          ...
          <p className="hero-deck">
            ...
            codebase, with clear roles, stack-specific expertise, and approval
            rules you control.
          </p>
          <div className="hero-actions">
            <CopyCommand command="npx wrkrs init" />
      ...
      <section className="how-section grid-shell" id="how-it-works">
        <div className="how-heading">
          ...
          <h2>From existing repo to a configured team.</h2>
          <p>
            Every teammate is an AI agent configured with a role, expertise,
            ...
            <div className="mini-runtime visual-surface">
              ...
              <div className="mini-terminal-screen claude-terminal-screen">
                ...
                <div className="claude-response">
                  <span>✦</span>
                  <div><strong>Product Manager</strong><p>I’ll inspect the repository and prepare a plan before implementation.</p></div>
                </div>
      ...
      <section className="statement grid-shell">
        ...
        <p>
          wrkrs configures your team; it does not host or replace your coding
      ...
      <section className="workflow-section" id="workflow">
        ...
        <div className="worker-model grid-shell">
          ...
          <div className="worker-crew" aria-label="A Product Manager starting three specialized Software Engineer instances">
            ...
            <div className="crew-branch">
              <span>starts only the engineers this task needs</span>
            </div>
            ...
            <p className="crew-note">
              <strong>One Software Engineer role. As many instances as the task needs.</strong>
      ...
      <section className="config-section grid-shell" id="configuration">
        <div className="config-copy">
          ...
          <h2>The configuration lives with the project.</h2>
          <p>
            Every role is an agent configured from plain files in your
        ...
        <div className="code-window">
          ...
          <pre>
            <code>
              <span className="yaml-section">team</span><span className="yaml-punct">:</span>{"\n"}
              {"  "}<span className="yaml-key">lead</span><span className="yaml-punct">:</span> <span className="yaml-value">product-manager</span>{"\n"}
              {"  "}<span className="yaml-key">worker_roles</span><span className="yaml-punct">:</span>{"\n"}
              {"    "}<span className="yaml-punct">-</span> <span className="yaml-value">product-designer</span>{"\n"}
              {"    "}<span className="yaml-punct">-</span> <span className="yaml-value">software-engineer</span>{"\n"}
              {"    "}<span className="yaml-punct">-</span> <span className="yaml-value">qa-engineer</span>{"\n\n"}
              <span className="yaml-section">software_engineer</span><span className="yaml-punct">:</span>{"\n"}
              {"  "}<span className="yaml-key">instances</span><span className="yaml-punct">:</span> <span className="yaml-value">dynamic</span>{"\n"}
              {"  "}<span className="yaml-key">specializations</span><span className="yaml-punct">:</span>{"\n"}
              {"    "}<span className="yaml-punct">-</span> <span className="yaml-value">macos-swift</span>{"\n"}
              {"    "}<span className="yaml-punct">-</span> <span className="yaml-value">web-frontend</span>{"\n"}
              {"    "}<span className="yaml-punct">-</span> <span className="yaml-value">backend</span>{"\n\n"}
              <span className="yaml-section">approval</span><span className="yaml-punct">:</span> <span className="yaml-punct">[</span><span className="yaml-approval">plan</span><span className="yaml-punct">,</span> <span className="yaml-approval">merge</span><span className="yaml-punct">,</span> <span className="yaml-approval">release</span><span className="yaml-punct">]</span>
            </code>
          </pre>
        </div>
      </section>
      ...
      <section className="install-safety grid-shell">
        ...
        <div className="safety-copy">
          ...
          <p>
            ...
            cannot merge safely. Existing Claude agents can be reused
            instead of replaced.
          </p>
        </div>
      </section>
      ...
      <section className="final-cta grid-shell" id="install">
        ...
        <p className="section-kicker">Not another workspace</p>
        <h2>Give your AI agents a real team structure.</h2>
        <p>
          Install reusable roles. Start only the agents each task needs.
        </p>
      ...
      <footer className="site-footer">
        ...
        <p>Open-source infrastructure for repository-owned AI teams.</p>
